...
> [!WARNING]
> Этот репозиторий предоставляет файлы **SA-MP SDK**, законным правообладателем которых является **Kalcor**, оригинальный создатель **SA-MP**. Здесь не заявляется никаких авторских прав на **SDK** — цель состоит исключительно в облегчении доступа и организации материалов для **разработчиков плагинов**. **Лицензия MIT** была применена исключительно формально, чтобы сохранить стандартную структуру **GitHub**, так как **оригинальная лицензия SDK** не была найдена. Эта лицензия не распространяется на оригинальное содержимое **SDK**, а только на возможные улучшения или дополнительные файлы, включённые в **репозиторий**.
...
Данное программное обеспечение лицензировано на условиях лицензии MIT ("Лицензия"); вы можете использовать это программное обеспечение в соответствии с условиями Лицензии. Копию Лицензии можно получить по адресу: [MIT License](https://opensource.org/licenses/MIT)

### Условия использования

#### 1. Предоставленные разрешения

Настоящая лицензия бесплатно предоставляет любому лицу, получившему копию данного программного обеспечения и связанных с ним файлов документации, следующие права:
...
- Разрешать лицам, которым предоставлено программное обеспечение, делать то же самое при соблюдении следующих условий.
...
- Приведенный ниже отказ от ответственности.

#### 3. Авторские права

Программное обеспечение и вся связанная с ним документация защищены законами об авторском праве. **SA-MP Programming Community** сохраняет за собой первоначальные авторские права на программное обеспечение.
...
НИ ПРИ КАКИХ ОБСТОЯТЕЛЬСТВАХ АВТОРЫ ИЛИ ПРАВООБЛАДАТЕЛИ НЕ НЕСУТ ОТВЕТСТВЕННОСТИ ЗА ЛЮБЫЕ ПРЕТЕНЗИИ, УБЫТКИ ИЛИ ИНУЮ ОТВЕТСТВЕННОСТЬ, БУДЬ ТО В СИЛУ ДОГОВОРА, ДЕЛИКТА ИЛИ ИНЫМ ОБРАЗОМ, ВОЗНИКАЮЩИЕ ИЗ, В СВЯЗИ С ИЛИ В РЕЗУЛЬТАТЕ ИСПОЛЬЗОВАНИЯ ПРОГРАММНОГО ОБЕСПЕЧЕНИЯ ИЛИ ДРУГИХ ДЕЙСТВИЙ С ПРОГРАММНЫМ ОБЕСПЕЧЕНИЕМ.

---

Для получения подробной информации о лицензии MIT посетите: https://opensource.org/licenses/MIT